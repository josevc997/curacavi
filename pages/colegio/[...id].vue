        ...
        <template v-if="colegio">
            <div class="col-span-12 flex flex-col gap-4">
                <div class="leading-tight pb-4">
                    <h1 class="text-2xl text-blue-800 font-bold col-span-12">
                        {{ toTitleCase(colegio.nombre) }}
                    </h1>
                    <p class="capitalize text-sm font-semibold text-blue-950">
                ...
                <div>
                    <NuxtImg
                        ...
                        :alt="colegio.nombre"
                        loading="lazy"
                        class="rounded-md object-cover object-center w-full h-80 sm:h-full sm:aspect-[5/2] shadow shadow-blue-500/40"
                    />
                </div>
                <section>
                    <div class="mt-4">
                        <div>
                            <div class="px-4 sm:px-0">
                                <h3
                                    class="text-lg font-semibold leading-7 text-blue-700"
                                >
                                    Información Institucional
                                </h3>
                                <p
                                    class="mt-1 max-w-2xl text-sm leading-6 text-blue-900"
                                >
                            ...
                            <div class="mt-6">
                                <dl class="grid grid-cols-1 sm:grid-cols-2">
                                    <div
                                        class="border-t border-blue-600/40 px-4 py-6 sm:col-span-1 col-span-2 sm:px-0"
                                    >
                                        <dt
                                            class="text-sm font-medium leading-6 text-blue-700"
                                        >
                                            Correo
                                        </dt>
                                        <dd
                                            class="mt-1 text-sm leading-6 text-blue-950 sm:mt-2"
                                        >
                                            {{ colegio.mail }}
                                        </dd>
                                    </div>
                                    ...
                                    <div
                                        class="border-t border-blue-600/40 px-4 py-6 col-span-1 sm:px-0"
                                    >
                                        <dt
                                            class="text-sm font-medium leading-6 text-blue-700"
                                        >
                                    ...
                                    <div
                                        class="border-t border-blue-600/40 px-4 py-6 col-span-2 sm:px-0"
                                    >
                                        <dt
                                            class="text-sm font-medium leading-6 text-blue-700"
                                        >
                                        ...
                                        <dd
                                            class="mt-1 text-sm leading-6 text-blue-950 sm:mt-2 grid gap-3"
                                        >
                                            <template
